<%@ page language="C#" autoeventwireup="true" inherits="Calculations, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/Calculations_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbCalculations_Operations.js"></script>
    ...
    <table id="Mastertbl_Calculations" style="width: 100%; height: 400px; font-family: Arial;
        font-size: small">
        <tr>
            <td>
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 5%">
                                                                            <input id="RdbSinglePersonel_Calculations" type="radio" value="V1" checked="checked"
                                                                                onclick="ChangeCalculatePersonnelCountState_Calculations('Single');" name="R1" />
                                                                        </td>
                                                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td id="headerPersonnelCount_Calculations" style="width: 22%">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                            ...
                                                            <ComponentArt:ComboBox ID="cmbPersonnel_Calculations" runat="server" AutoComplete="true"
                                                                ...
                                                                <DropDownHeader>
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="400">
                                                                        <tr class="headingRow">
                                                                            <td id="clmnName_cmbPersonnel_Calculations" class="headingCell" style="width: 40%;
                                                                                text-align: center">
                                                                                Name And Family
                                                                            </td>
                                                                            <td id="clmnBarCode_cmbPersonnel_Calculations" class="headingCell" style="width: 30%;
                                                                                text-align: center">
                                                                                BarCode
                                                                            </td>
                                                                            <td id="clmnCardNum_cmbPersonnel_Calculations" class="headingCell" style="width: 30%;
                                                                                text-align: center">
                                                                                CardNum
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <ClientEvents>
                                                                    ...
                                                                    <Collapse EventHandler="cmbPersonnel_Calculations_onCollapse" />
                                            ...
                                            <tr>
                                                <td>
                                                    <input id="txtPersonnelSearch_Calculations" runat="server" class="TextBoxes" onclick="this.select();"
                                                        onfocus="this.select();" style="width: 98%" type="text" />
                                                </td>
                                                <td>
        ...
        <tr>
            <td>
                <table id="Container_CalculationProgressFeatures" align="center" style="width: 99%;
                    visibility: hidden">
                    <tr>
                        <td>
                            <div id="Progressbar_Calculations" style="font-size: 8pt; padding: 2px; border: solid black 1px;
                                width: 100%">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 1%" id="p1_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p2_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p3_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p4_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p5_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p6_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p7_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p8_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p9_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p10_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p11_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p12_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p13_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p14_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p15_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p16_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p17_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p18_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p19_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p20_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p21_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p22_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p23_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p24_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p25_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p26_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p27_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p28_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p29_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p30_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p31_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p32_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p33_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p34_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p35_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p36_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p37_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p38_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p39_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p40_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p41_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p42_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p43_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p44_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p45_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p46_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p47_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p48_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p49_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p50_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p51_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p52_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p53_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p54_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p55_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p56_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p57_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p58_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p59_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p60_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p61_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p62_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p63_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p64_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p65_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p66_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p67_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p68_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p69_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p70_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p71_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p72_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p73_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p74_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p75_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p76_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p77_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p78_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p79_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p80_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p81_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p82_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p83_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p84_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p85_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p86_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p87_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p88_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p89_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p90_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p91_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p92_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p93_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p94_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p95_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p96_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p97_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p98_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p99_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                        <td style="width: 1%" id="p100_Progressbar_Calculations">
                                            &nbsp;
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 33%" id="tdCalculatedPersonnelCount_Calculations">
                                    </td>
                                    <td style="width: 33%" id="tdAllPersonnelCount_Calculations">
                                    </td>
                                    <td style="width: 33%" id="tdProgressPercentage_Calculations">
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <asp:HiddenField runat="server" ID="hfAllPersonnelCount_Calculations" meta:resourcekey="hfAllPersonnelCount_Calculations" />
    <asp:HiddenField runat="server" ID="hfCalculatedPersonnelCount_Calculations" meta:resourcekey="hfCalculatedPersonnelCount_Calculations" />
    <asp:HiddenField runat="server" ID="hfProgressPercentage_Calculations" meta:resourcekey="hfProgressPercentage_Calculations" />
    </form>
</body>
</html>
