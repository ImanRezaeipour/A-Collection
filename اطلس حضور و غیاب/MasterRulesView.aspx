<%@ page language="C#" autoeventwireup="true" inherits="MasterRulesView, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/MasterRulesView_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogMasterRulesView_Operations.js"></script>
                                ...
                                <tr>
                                    <td>
                                        <table style="width: 100%;" class="BoxStyle">
                                            ...
                                            <tr>
                                                <td>
                                                    <iframe id="RulesView_iFrame" runat="server" align="middle" allowtransparency="true" class="RulesView_iFrame"
