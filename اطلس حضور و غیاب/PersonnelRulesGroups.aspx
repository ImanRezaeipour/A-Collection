<%@ page language="C#" autoeventwireup="true" inherits="PersonnelRulesGroups, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/PersonnelRulesGroups_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogPersonnelRulesGroups_Operations.js"></script>
                            ...
                            <ComponentArt:ToolBar ID="TlbPersonnelRulesGroups" runat="server" CssClass="toolbar"
                                ...
                                <Items>
                                    ...
                                    <ComponentArt:ToolBarItem ID="tlbItemFormReconstruction_TlbRulesGroup" runat="server"
                                        ...
                                        ItemType="Command" meta:resourcekey="tlbItemFormReconstruction_TlbRulesGroup" TextImageSpacing="5" />
        ...
        <tr>
            <td>
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 40%">
                            <asp:Label ID="lblRuleName_PersonnelRulesGroups" runat="server" Text=": نام قانون"
                                CssClass="WhiteLabel" meta:resourcekey="lblRuleName_PersonnelRulesGroups"></asp:Label>
                        </td>
                        <td style="width: 30%">
                    ...
                    <tr>
                                ...
                                <Content>
                                    <ComponentArt:ComboBox ID="cmbRulesGroups_PersonnelRulesGroups" runat="server" AutoComplete="true"
                                        ...
                                        <ClientEvents>
                                            ...
                                            <Collapse EventHandler="cmbRulesGroups_PersonnelRulesGroups_onCollapse" />
                                        </ClientEvents>
                        ...
                        <td valign="top" id="Container_FromDateCalendars_PersonnelRulesGroups">
                            <table runat="server" id="Container_pdpFromDate_PersonnelRulesGroups" visible="false"
                                ...
                                <tr>
                                    <td>
                                        <pcal:PersianDatePickup ID="pdpFromDate_PersonnelRulesGroups" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" id="Container_ToDateCalendars_PersonnelRulesGroups">
                            <table runat="server" id="Container_pdpToDate_PersonnelRulesGroups" visible="false"
                                ...
                                <tr>
                                    <td>
                                        <pcal:PersianDatePickup ID="pdpToDate_PersonnelRulesGroups" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="RuleCategory.ID" Visible="false" />
