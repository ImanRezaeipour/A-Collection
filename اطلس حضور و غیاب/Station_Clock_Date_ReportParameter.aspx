<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.Station_Clock_Date_ReportParameter, App_Web_aaak0nyc" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/Station_Clock_Date_ReportParameter_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/Station_Clock_Date_ReportParameter_Operations.js"></script>
            ...
            <tr>
                <td valign="top">
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 45%">
                                <asp:Label ID="lblFrom_Station_Clock_Date_ReportParameter" runat="server" Text="از تاریخ :"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTo_Station_Clock_Date_ReportParameter" runat="server" Text="تا تاریخ :"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblStation_Station_Clock_Date_ReportParameter" runat="server" Text="ایستگاه :"
                                    ...
                                    <Content>
                                        <ComponentArt:ComboBox ID="cmbStation_Station_Clock_Date_ReportParameter" runat="server"
                                            ...
                                            <ClientEvents>
                                                ...
                                                <Collapse EventHandler="cmbStation_Station_Clock_Date_ReportParameter_onCollapse" />
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblClock_Station_Clock_Date_ReportParameter" runat="server" Text="دستگاه :"
                                    ...
                                    <Content>
                                        <ComponentArt:ComboBox ID="cmbClock_Station_Clock_Date_ReportParameter" runat="server"
                                            ...
                                            <ClientEvents>
                                                ...
                                                <Collapse EventHandler="cmbClock_Station_Clock_Date_ReportParameter_onCollapse" />
                                            </ClientEvents>
                                        </ComponentArt:ComboBox>
