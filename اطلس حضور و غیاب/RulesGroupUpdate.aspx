<%@ page language="C#" autoeventwireup="true" inherits="RulesGroupUpdate, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/RulesGroupUpdate_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogRulesGroupUpdate_Operations.js"></script>
    <script type="text/javascript" src="JS/API/DialogRuleParameters_onPageLoad.js"></script>
                            ...
                            <ComponentArt:ToolBar ID="TlbRulesGroupUpdate" runat="server" CssClass="toolbar"
                                ...
                                <Items>
                                    ...
                                    <ComponentArt:ToolBarItem ID="tlbItemRuleGroupRulesParametersValidation_TlbRulesGroupUpdate"
                                        ...
                                        DropDownImageHeight="16px" DropDownImageWidth="16px" Enabled="true" ImageHeight="16px"
                                        ImageUrl="RuleGroupRulesParametersValidation.png" ImageWidth="16px" ItemType="Command" meta:resourcekey="tlbItemRuleGroupRulesParametersValidation_TlbRulesGroupUpdate"
                                        TextImageSpacing="5" />
    ...
    <ComponentArt:Dialog ModalMaskImage="Images/Dialog/alpha.png" HeaderCssClass="headerCss"
        ...
        <ClientTemplates>
            <ComponentArt:ClientTemplate ID="DialogRuleParametersheader">
                <table id="tbl_DialogRuleParametersheader" style="width: 603px;" cellpadding="0"
            ...
            <ComponentArt:ClientTemplate ID="DialogRuleParametersfooter">
                <table id="tbl_DialogRuleParametersfooter" style="width: 603px" cellpadding="0" cellspacing="0"
                    border="0">
                    <tr>
                        <td width="6">
