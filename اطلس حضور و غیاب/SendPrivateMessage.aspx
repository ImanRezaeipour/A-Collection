<%@ page language="C#" autoeventwireup="true" inherits="SendPrivateMessage, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/SendPrivateMessage_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogSendPrivateMessage_Operations.js"></script>
                                                                        ...
                                                                        <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <ComponentArt:GridColumn Align="Center" DataField="Name" DefaultSortDirection="Descending"
                                                                                    Width="150" HeadingText="نام" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnName_GridUnderManagementPersonnel_SendPrivateMessage" />
                                    ...
                                    <tr id="Tr14" runat="server" meta:resourcekey="AlignObj">
                                        <td>
                                            <textarea id="txtSendPrivateMessageMessage_SendPrivateMessageIntroduction" cols="20"
                                                rows="6" style="width: 98%; height: 80px;" class="TextBoxes" onfocus="this.select();"
                                                onclick="this.select();" name="S1"></textarea>
                                        </td>
                                    </tr>
                                </table>
                            </td>
    ...
    <asp:HiddenField runat="server" ID="hfheader_tblPrivateMessageDetails_PrivateMessageIntroduction" meta:resourcekey="hfheader_tblPrivateMessageDetails_PrivateMessageIntroduction" />
    <asp:HiddenField runat="server" ID="hfSendTo_tblPrivateMessageDetails_PrivateMessageIntroduction" meta:resourcekey="hfSendTo_tblPrivateMessageDetails_PrivateMessageIntroduction" />
