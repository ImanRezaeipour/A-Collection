<%@ page language="C#" autoeventwireup="true" inherits="MasterDataAccessLevels, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/MasterDataAccessLevels_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogMasterDataAccessLevels_Operations.js"></script>
        ...
        <tr>
            <td>
                <table style="width: 60%;">
                    <tr>
                        <td style="width: 25%">
                            <asp:Label ID="lblDataAccessLevels_MasterDataAccessLevels" runat="server" Text=": سطوح دسترسی داده"
                            ...
                            <ComponentArt:CallBack ID="CallBack_cmbDataAccessLevels_MasterDataAccessLevels" runat="server"
                                ...
                                <Content>
                                    <ComponentArt:ComboBox ID="cmbDataAccessLevels_MasterDataAccessLevels" runat="server"
                                        ...
                                        Style="width: 100%" TextBoxCssClass="comboTextBox" DropDownHeight="250">
                                        <ClientEvents>
