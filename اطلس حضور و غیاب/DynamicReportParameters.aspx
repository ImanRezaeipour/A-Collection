<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.DynamicReportParameters, App_Web_aaak0nyc" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/DynamicReportParameters_onPageLoad.js"></script>
    <form runat="server">  
