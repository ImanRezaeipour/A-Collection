<%@ page language="C#" autoeventwireup="true" inherits="EndorsementFlowState, App_Web_gtuecu1w" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/EndorsementFlowState_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogEndorsementFlowState_Operations.js"></script>
                ...
                <ComponentArt:CallBack runat="server" ID="CallBack_GridEndorsementFlowState_EndorsementFlowState"
                    ...
                    <Content>
                        <ComponentArt:DataGrid ID="GridEndorsementFlowState_EndorsementFlowState" runat="server"
                            AllowHorizontalScrolling="false" CssClass="Grid" EnableViewState="true" ShowFooter="false"
                        ...
                        <asp:HiddenField runat="server" ID="ErrorHiddenField_EndorsementFlowState" />
                    </Content>
                    <ClientEvents>
