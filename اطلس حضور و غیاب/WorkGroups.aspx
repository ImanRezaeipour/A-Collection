<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.WorkGroups, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/tbWorkGroups_TabStripMenus_Operations.js"
        id="tbWorkGroups_TabStripMenus_Operations"></script>
    <script type="text/javascript" src="JS/API/WorkGroups_onPageLoad.js" id="WorkGroups_onPageLoad.js"></script>
                                        ...
                                        <ComponentArt:CallBack runat="server" ID="CallBack_GridWorkGroups_WorkGroups" OnCallback="CallBack_GridWorkGroups_WorkGroups_onCallBack">
                                            <Content>
                                                <ComponentArt:DataGrid ID="GridWorkGroups_WorkGroups" runat="server" ShowFooter="false"
                                                    CssClass="Grid" EnableViewState="true" FillContainer="true" ImagesBaseUrl="images/Grid/"
                                                        ...
                                                        <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <ComponentArt:GridColumn Align="Center" DataField="CustomCode" DefaultSortDirection="Descending"
                                                                    HeadingText="کد گروه" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnGroupCode_GridWorkGroups_WorkGroups" />
                                                                <ComponentArt:GridColumn Align="Center" DataField="Name" DefaultSortDirection="Descending"
                                                                    HeadingText="نام گروه" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnGroupName_GridWorkGroups_WorkGroups" />
                                                            </Columns>
                                                ...
                                                <td>
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td style="width: 20%">
                                                                <ComponentArt:ToolBar ID="TlbCalendar_WorkGroups" runat="server" CssClass="toolbar"
                                                                    DefaultItemActiveCssClass="itemActive" DefaultItemCheckedCssClass="itemChecked"
                                                                    DefaultItemCheckedHoverCssClass="itemActive" DefaultItemCssClass="item" DefaultItemHoverCssClass="itemHover"
                                                                    DefaultItemImageHeight="16px" DefaultItemImageWidth="16px" DefaultItemTextImageRelation="ImageBeforeText"
                                                                    ImagesBaseUrl="images/ToolBar/" ItemSpacing="1px" UseFadeEffect="false">
                                                                    <Items>
                                                                        <ComponentArt:ToolBarItem ID="tlbItemCalendar_TlbCalendar_WorkGroups" runat="server"
                                                                            ClientSideCommand="tlbItemCalendar_TlbCalendar_WorkGroups_onClick();" DropDownImageHeight="16px"
                                                                            DropDownImageWidth="16px" ImageHeight="16px" ImageUrl="Calendar_silver.png" ImageWidth="16px"
                                                                            ItemType="Command" meta:resourcekey="tlbItemCalendar_TlbCalendar_WorkGroups"
