<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.MasterUnderManagementPersonnelExeptionAccessView, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/MasterUnderManagementPersonnelExeptionAccessView_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogUnderManagementPersonnelExeptionAccessView_Operations.js"></script>
    ...
    <table style="width: 100%; background-image: url('Images/Ghadir/bg-body.jpg'); font-family: Arial;
        ...
        <tr>
            <td>
                <table style="width: 100%;">
                    ...
                    <tr align="center">
                        <td>
                            <input id="txtManager_MasterUnderManagementPersonnelExeptionAccessView" type="text" disabled="disabled"
                                style="background-color: #DCDCDC" />
                        </td>
                        <td>
                            <input id="txtAccessGroup_MasterUnderManagementPersonnelExeptionAccessView" type="text" disabled="disabled"
                                style="background-color: #DCDCDC" />
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td>
                <table style="background-image: url('Images/Ghadir/bg-body.jpg'); background-repeat: repeat; border: outset 1px black;
                    width: 100%">
                    <tr>
                    ...
                    <tr>
                        <td>
                            <iframe allowtransparency="true" runat="server" id="MasterUnderManagementPersonnelExeptionAccessView_iFrame" src="UnderManagementPersonnelExeptionAccessView.aspx"
                                class="MasterUnderManagementPersonnelExeptionAccessView_iFrame" frameborder="0" align="middle"
                                name="I1"></iframe>
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <ComponentArt:ToolBar ID="TlbPaging_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView"
                                            ...
                                            <Items>
                                                ...
                                                <ComponentArt:ToolBarItem ID="tlbItemLast_TlbPaging_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView"
                                                    runat="server" ClientSideCommand="" DropDownImageHeight="16px" DropDownImageWidth="16px"
                                                    Enabled="true" ImageHeight="16px" ImageWidth="16px" ItemType="Command"
                                                    meta:resourcekey="tlbItemLast_TlbPaging_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView"
                                                    TextImageSpacing="5" />
                                                ...
                                                <ComponentArt:ToolBarItem ID="tlbItemFirst_TlbPaging_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView"
                                                    runat="server" ClientSideCommand="" DropDownImageHeight="16px" DropDownImageWidth="16px"
                                                    Enabled="true" ImageHeight="16px"  ImageWidth="16px" ItemType="Command"
                                                    meta:resourcekey="tlbItemFirst_TlbPaging_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView"
                                                    TextImageSpacing="5" />
                                            </Items>
                                        </ComponentArt:ToolBar>
                                    </td>
                                    <td id="footer_GridUnderManagementPersonnelExeptionAccessView_MasterUnderManagementPersonnelExeptionAccessView" style="width: 15%" runat="server" meta:resourcekey="InverseAlignObj">                                        
                                    Page 0 of 0
                                    </td>
                                </tr>
                            </table>
