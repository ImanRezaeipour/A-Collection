<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.OrganizationPosts, App_Web_gtuecu1w" %>
                                        ...
                                        <ComponentArt:CallBack runat="server" ID="CallBack_trvPosts_Post" OnCallback="CallBack_trvPosts_Post_onCallBack">
                                            <Content>
                                                <ComponentArt:TreeView ID="trvPosts_Post" runat="server" ExpandNodeOnSelect="true"
                                                    ...
                                                    LineImageHeight="20" LineImageWidth="19" NodeCssClass="TreeNode" NodeEditCssClass="NodeEdit" LoadingFeedbackText="Loading"
                                                    NodeIndent="17" NodeLabelPadding="3" meta:resourcekey="trvPosts_Post" SelectedNodeCssClass="SelectedTreeNode"
                                                    ShowLines="true">
                                                    <ClientEvents>
