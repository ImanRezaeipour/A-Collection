<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.MasterExceptionShifts, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/MasterExceptionShifts_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbMasterExceptionShifts_TabStripMenus_Operations.js"></script>
                                                                            ...
                                                                            <Content>
                                                                                <ComponentArt:ComboBox ID="cmbPersonnel_MasterExceptionShifts" runat="server" AutoComplete="true"
                                                                                    ...
                                                                                    <ClientEvents>
                                                                                        ...
                                                                                        <Collapse EventHandler="cmbPersonnel_MasterExceptionShifts_onCollapse" />
                                                                                    </ClientEvents>
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="width: 40%" id="Container_FromDateCalendars_MasterExceptionShifts">
                                                    <table runat="server" id="Container_pdpMasterFromDate_MasterExceptionShifts" visible="false" style="width:100%">
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <table runat="server" id="Container_gdpMasterFromDate_MasterExceptionShifts" visible="false" style="width:100%">
                                                        <tr>
                                                            <td>
                                                ...
                                                <td id="Container_ToDateCalendars_MasterExceptionShifts" style="width: 40%">
                                                    <table runat="server" id="Container_pdpMasterToDate_MasterExceptionShifts" visible="false" style="width:100%">
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <table id="Container_gdpMasterToDate_MasterExceptionShifts" runat="server" visible="false" style="width:100%">
                                                        <tr>
                                                            <td>
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="Shift.ID" Visible="false" />
                                                    <ComponentArt:GridColumn Align="Center" DataField="Shift.Name" DefaultSortDirection="Descending"
                                                        HeadingText="نام شیفت" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnShiftName_GridMasterExceptionShifts_MasterExceptionShifts" />
                                                    ...
                                                    <ComponentArt:GridColumn Align="Center" DataField="Person.Name" DefaultSortDirection="Descending"
                                                        HeadingText="نام و نام خانوادگی" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnPersonnelName_GridMasterExceptionShifts_MasterExceptionShifts" />
                                                </Columns>
