<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.CollectiveTraffic, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/CollectiveTraffic_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogCollectiveTraffic_Operations.js"></script>
    ...
    <table style="width: 100%; height: 460px; background-image: url('Images/Ghadir/bg-body.jpg');
