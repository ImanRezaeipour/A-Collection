<%@ page language="C#" autoeventwireup="true" inherits="RuleParameters, App_Web_gtuecu1w" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/RuleParameters_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogRuleParameters_Operations.js"></script>
    ...
    <table style="width: 100%;" class="BoxStyle">
                ...
                <table style="width: 100%;" class="BoxStyle">
                    <tr>
                        <td>
                            <table style="width: 100%">
                                <tr>
                                    <td id="header_RuleDateRanges_RuleParameters" class="HeaderLabel" style="width: 65%">
                                        Rule Date Ranges
                                    </td>
                                    <td id="loadingPanel_GridRuleDateRanges_RuleParameters" class="HeaderLabel" style="width: 30%">
                                    </td>
                ...
                <table style="width: 100%;" class="BoxStyle">
                    <tr>
                        <td id="" class="HeaderLabel">
                            <table style="width: 100%">
                                <tr>
                                    <td id="header_RuleParameters_RuleParameters" class="HeaderLabel" style="width: 50%">
                                        Rule Parameteres
                                    </td>
                                    <td id="loadingPanel_GridRuleParameters_RuleParameters" class="HeaderLabel" style="width: 45%">
                                    </td>
                                    <td runat="server" style="width: 5%" meta:resourcekey="InverseAlignObj">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <table dir="ltr" style="width: 70%">
                                                    <tr>
                                                        <td align="center" style="width: 49%">
                                                            <input type="text" id="TimeSelector_Hour_RuleParameters_txtHour" style="width: 70%;
                                                        ...
                                                        <td align="center" style="width: 49%">
                                                            <input type="text" id="TimeSelector_Hour_RuleParameters_txtMinute" style="width: 70%;
        ...
        <tr>
            <td valign="top" colspan="2">
                <textarea id="txtRuleTitle_RuleParameters" cols="20" name="S1" rows="3" style="height: 60px;
                    width: 99%" class="TextBoxes" readonly="readonly"></textarea>
            </td>
        </tr>
    </table>
