<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.MasterPersonnel, App_Web_gtuecu1w" %>
                    ...
                    <tr>
                        <td style="width: 80%">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <input type="text" runat="server" style="width: 99%;" class="TextBoxes" id="txtSerchTerm_Personnel" onfocus="this.select();" onclick="this.select();"/>
                                    </td>
                                    <td style="width: 5%">
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R16Text" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R17" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R17Text" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R18" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R18Text" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R19" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R19Text" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R20" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="PersonDetail.R20Text" Visible="false" />
                                                </Columns>
