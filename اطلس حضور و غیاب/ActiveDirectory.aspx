<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.ActiveDirectory, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/ActiveDirectory_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogActiveDirectory_Operations.js"></script>
                                ...
                                <tr>
                                    <td style="width: 100%">
                                        <ComponentArt:DataGrid ID="GridActiveDirectory_ActiveDirectory" runat="server" CallbackCacheSize="20000"
                                            CallbackCachingEnabled="true" CssClass="Grid" EnableViewState="true" FillContainer="false"
