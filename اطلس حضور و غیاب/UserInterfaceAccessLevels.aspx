<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.UserInterfaceAccessLevels, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/DialogUserInterfaceAccessLevels_Operations.js"></script>
    <script type="text/javascript" src="JS/API/UserInterfaceAccessLevels_onPageLoad.js"></script>
            ...
            <td>
                <ComponentArt:ToolBar ID="TlbAccessLevelsAsign" runat="server" CssClass="toolbar"
                    ...
                    <Items>
                        ...
                        <ComponentArt:ToolBarItem ID="tlbItemFormReconstruction_TlbAccessLevelsAsign"
                            runat="server" ClientSideCommand="tlbItemFormReconstruction_TlbAccessLevelsAsign_onClick();"
        ...
        <tr>
            <td>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            <input type="text" runat="server" style="width: 99%;" class="TextBoxes" id="txtUserGroupName_AccessLevelsAsign"
                                readonly="readonly" />
                        </td>
                    </tr>
                </table>
