<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.FromDate_ToDate_ReportParameter, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/FromDate_ToDate_ReportParameter_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/FromDate_ToDate_ReportParameter_Operations.js"></script>
    ...
    <div style="height: 290px;" class="BoxStyle">
        <table id="tblMain_FromDate_ToDate_ReportParameter" style="width: 100%; font-family: Arial;
            ...
            <tr>
                <td style="width: 45%">
                    <asp:Label ID="lblFrom_FromDate_ToDate_ReportParameter" runat="server" Text="از تاریخ :"
                ...
                <td id="Container_fromDateCalendars_RuleParameters">
                    <table runat="server" id="Container_pdpfromDate_RuleParameters" visible="false" style="width: 100%">
                        <tr>
                            <td>
                                <pcal:PersianDatePickup ID="pdpfromDate_RuleParameters" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblTo_FromDate_ToDate_ReportParameter" runat="server" Text=" تا تاریخ :"
                ...
                <td id="Container_toDateCalendars_RuleParameters">
                    <table runat="server" id="Container_pdptoDate_RuleParameters" visible="false" style="width: 100%">
                        <tr>
                            <td>
                                <pcal:PersianDatePickup ID="pdptoDate_RuleParameters" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                            </td>
                        </tr>
                    </table>
