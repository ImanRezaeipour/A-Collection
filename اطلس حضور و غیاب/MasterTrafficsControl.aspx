<%@ page language="C#" autoeventwireup="true" inherits="MasterTrafficsControl, App_Web_vccxcelb" %>
...
<body onkeydown="MasterTrafficsControl_onKeyDown(event)">
    ...
    <script type="text/javascript" src="JS/API/MasterTrafficsControl_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbMasterTrafficsControl_TabStripMenus_Operations.js"></script>
                                                                    ...
                                                                    <Content>
                                                                        <ComponentArt:ComboBox ID="cmbPersonnel_MasterTrafficsControl" runat="server" AutoComplete="true"
                                                                            ...
                                                                            <ClientEvents>
                                                                                ...
                                                                                <Collapse EventHandler="cmbPersonnel_MasterTrafficsControl_onCollapse" />
                                                                            </ClientEvents>
                                                        ...
                                                        <tr>
                                                            <td style="width: 90%">
                                                                <input id="txtPersonnelSearch_MasterTrafficsControl" runat="server" class="TextBoxes"
                                                                    onclick="this.select();" onfocus="this.select();" style="width: 95%" type="text" />
                                                            </td>
                                                            <td style="width: 10%">
    ...
    <ComponentArt:Dialog ModalMaskImage="Images/Dialog/alpha.png" HeaderCssClass="headerCss"
        ...
        <Content>
            <table id="Mastertbl_DialogTrafficsControl_MasterTrafficsControl" style="width: 100%;" class="BodyStyle">
                <tr>
                    <td>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td id="Container_DateCalendars_MasterTrafficsControl">
                                    <table runat="server" id="Container_pdpDate_MasterTrafficsControl" visible="false" style="width: 100%">
                                        <tr>
                                            <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <textarea id="txtDescription_MasterTrafficsControl" cols="20" name="S1" rows="2"
                                        style="width: 100%; height: 50px" onfocus="this.select();" onclick="this.select();"></textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
