<%@ page language="C#" autoeventwireup="true" inherits="CalculationRange, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/CalculationRange_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogCalculationRange_Operations.js"></script>
    <script type="text/javascript" src="JS/API/NumericUpDown.js"></script>
                                ...
                                <tr>
                                    <td>
                                        <textarea id="txtDescription_CalculationRange" cols="20" rows="2" style="width: 98%;
                                            height: 70px;" class="TextBoxes" onclick="this.select();" onfocus="this.select();"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </td>
