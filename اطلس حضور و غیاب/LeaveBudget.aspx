<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.LeaveBudget, App_Web_gtuecu1w" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/LeaveBudget_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogLeaveBudget_Operations.js"></script>
                        ...
                        <td>
                            <ComponentArt:ToolBar ID="TlbLeaveBudget_LeaveBudget" runat="server" CssClass="toolbar"
                                ...
                                <Items>
                                    ...
                                    <ComponentArt:ToolBarItem ID="tlbItemFormReconstruction_TlbLeaveBudget_LeaveBudget" runat="server"
                                        ClientSideCommand="tlbItemFormReconstruction_TlbLeaveBudget_LeaveBudget_onClick();" DropDownImageHeight="16px"
                                        DropDownImageWidth="16px" ImageHeight="16px" ImageUrl="refresh.png" ImageWidth="16px"
                                        ItemType="Command" meta:resourcekey="tlbItemFormReconstruction_TlbLeaveBudget_LeaveBudget"
                                        TextImageSpacing="5" />
                    ...
                    <tr>
                        ...
                        <td style="width:5%">
                                        <ComponentArt:ToolBar ID="TlbView_LeaveBudget" runat="server" CssClass="toolbar"
                                            ...
                                            <Items>
                                                <ComponentArt:ToolBarItem ID="tlbItemView_TlbView_LeaveBudget" runat="server"
                                                    DropDownImageHeight="16px" DropDownImageWidth="16px" ImageHeight="16px" ImageUrl="NormalView.png"
                                                    ClientSideCommand="tlbItemView_TlbView_LeaveBudget_onClick();" ImageWidth="16px"
                                                    ItemType="Command" meta:resourcekey="tlbItemView_TlbView_LeaveBudget"
                                                    TextImageSpacing="5" />
                                            </Items>
                                        </ComponentArt:ToolBar>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 5%">
                                        <input id="rdbYearBudget_LeaveBudget" type="radio" name="Budget" checked="checked" onclick="rdbYearBudget_LeaveBudget_onClick();"/>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td align="center">
                            <table style="width: 70%;">
                                <tr>
                                    <td style="width: 30%">
                                        <input id="txtYearBudgetDay_LeaveBudget" type="text" class="TextBoxes" style="width: 80%; text-align:center" onchange="DayBox_LeaveBudget_onChange('txtYearBudgetDay_LeaveBudget')" onfocus="this.select()" onclick="this.select()" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth1_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth1_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth2_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth2_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth3_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth3_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth4_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth4_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth5_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth5_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth6_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth6_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth7_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth7_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth8_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth8_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth9_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth9_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth10_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth10_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth11_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth11_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <td rowspan="2">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <input type="text" runat="server" style="width: 90%; text-align:center" class="TextBoxes" id="txtMonth12_LeaveBudget" onchange="DayBox_LeaveBudget_onChange('txtMonth12_LeaveBudget')" onfocus="this.select()" onclick="this.select()"/></td>
                                            </tr>
                                            <tr>
                                                <td>
