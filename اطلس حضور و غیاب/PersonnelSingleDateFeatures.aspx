<%@ page language="C#" autoeventwireup="true" inherits="PersonnelSingleDateFeatures, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type='text/javascript' src='JS/API/PersonnelSingleDateFeatures_onPageLoad.js'></script>
    <script type='text/javascript' src='JS/API/DialogPersonnelSingleDateFeatures_Operations.js'></script>
                                ...
                                <Content>
                                    <ComponentArt:ComboBox ID="cmbSingleDateFeatures_PersonnelSingleDateFeatures" runat="server"
                                        ...
                                        <ClientEvents>
                                            ...
                                            <Collapse EventHandler="cmbSingleDateFeatures_PersonnelSingleDateFeatures_onCollapse" />
                                        </ClientEvents>
                                            ...
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn Align="Center" DataField="" DefaultSortDirection="Descending"
                                                        HeadingText="نام" HeadingTextCssClass="HeadingText" Visible="true" />
                                                    <ComponentArt:GridColumn Align="Center" DataField="UIFromDate" DefaultSortDirection="Descending"
                                                        HeadingText="از تاریخ" HeadingTextCssClass="HeadingText" Visible="true" />
                                                </Columns>
