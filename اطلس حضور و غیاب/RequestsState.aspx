<%@ page language="C#" autoeventwireup="true" inherits="RequestsState, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/RequestsState_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogRequestsState_Operations.js"></script>
        ...
        <tr>
            <td>
                <ComponentArt:DataGrid ID="GridRequestsState_RequestsState" runat="server" AllowHorizontalScrolling="true"
                    CallbackCacheSize="20000" CallbackCachingEnabled="true" CssClass="Grid" EnableViewState="true"
