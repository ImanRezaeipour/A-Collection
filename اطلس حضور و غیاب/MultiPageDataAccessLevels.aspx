<%@ page language="C#" autoeventwireup="true" inherits="MultiPageDataAccessLevels, App_Web_aaak0nyc" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/MultiPageDataAccessLevels_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/MultiPageDataAccessLevels_Operations.js"></script>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <table style="width: 100%;" class="BoxStyle">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels" runat="server" meta:resourcekey="lblDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels"
                                            ...
                                            <tr>
                                                <td style="width: 80%">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td>
                                                                <input type="text" runat="server" style="width: 99%;" class="TextBoxes" id="txtDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels" />
                                                            </td>
                                                            <td style="width: 5%">
                                                                <ComponentArt:ToolBar ID="TlbDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels" runat="server" CssClass="toolbar"
                                                                    ...
                                                                    UseFadeEffect="false">
                                                                    <Items>
                                                                        <ComponentArt:ToolBarItem ID="tlbItemSearch_TlbDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels" runat="server"
                                                                            ClientSideCommand="tlbItemSearch_TlbDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels_onClick();" DropDownImageHeight="16px"
                                                                            DropDownImageWidth="16px" ImageHeight="16px" ImageUrl="search.png" ImageWidth="16px"
                                                                            ItemType="Command" meta:resourcekey="tlbItemSearch_TlbDataAccessLevelsSourceQuickSearch_MultiPageDataAccessLevels" TextImageSpacing="5" />
                                                                    </Items>
                                            ...
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn Align="Center" DataField="CustomCode" DefaultSortDirection="Descending"
                                                        HeadingText="کد" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnDataAccessLevelSourceCode_GridDataAccessLevelsSource_MultiPageDataAccessLevels" />
                                                    <ComponentArt:GridColumn Align="Center" DataField="Name" DefaultSortDirection="Descending"
                                                        HeadingText="نام" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnDataAccessLevelName_GridDataAccessLevelsSource_MultiPageDataAccessLevels" />
                                                </Columns>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td style="width: 64%;" runat="server" meta:resourcekey="AlignObj">
                                        <ComponentArt:ToolBar ID="TlbPaging_GridDataAccessLevelsSource_MultiPageDataAccessLevels" runat="server" CssClass="toolbar"
                                            DefaultItemActiveCssClass="itemActive" DefaultItemCheckedCssClass="itemChecked"
                                            DefaultItemCheckedHoverCssClass="itemActive" DefaultItemCssClass="item" DefaultItemHoverCssClass="itemHover"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table style="width: 100%;" class="BoxStyle">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels" runat="server" meta:resourcekey="lblDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels"
                                                        Text=": جستجوی سریع" CssClass="WhiteLabel"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 80%">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td>
                                                                <input type="text" runat="server" style="width: 99%;" class="TextBoxes" id="txtDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels" />
                                                            </td>
                                                            <td style="width: 5%">
                                                                <ComponentArt:ToolBar ID="TlbDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels" runat="server" CssClass="toolbar"
                                                                    DefaultItemActiveCssClass="itemActive" DefaultItemCheckedCssClass="itemChecked"
                                                                    DefaultItemCheckedHoverCssClass="itemActive" DefaultItemCssClass="item" DefaultItemHoverCssClass="itemHover"
                                                                    DefaultItemImageHeight="16px" DefaultItemImageWidth="16px" DefaultItemTextImageRelation="ImageBeforeText"
                                                                    DefaultItemTextImageSpacing="0" ImagesBaseUrl="images/ToolBar/" ItemSpacing="1px"
                                                                    UseFadeEffect="false">
                                                                    <Items>
                                                                        <ComponentArt:ToolBarItem ID="tlbItemSearch_TlbDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels" runat="server"
                                                                            ClientSideCommand="tlbItemSearch_TlbDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels_onClick();" DropDownImageHeight="16px"
                                                                            DropDownImageWidth="16px" ImageHeight="16px" ImageUrl="search.png" ImageWidth="16px"
                                                                            ItemType="Command" meta:resourcekey="tlbItemSearch_TlbDataAccessLevelsTargetQuickSearch_MultiPageDataAccessLevels" TextImageSpacing="5" />
                                                                    </Items>
                                                                </ComponentArt:ToolBar>
                                                            </td>
                                                        </tr>
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    <ComponentArt:GridColumn DataField="ID" Visible="false" />
                                                    <ComponentArt:GridColumn Align="Center" DataField="CustomCode" DefaultSortDirection="Descending"
                                                        HeadingText="کد" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnDataAccessLevelSourceCode_GridDataAccessLevelsTarget_MultiPageDataAccessLevels" />
                                                    <ComponentArt:GridColumn Align="Center" DataField="Name" DefaultSortDirection="Descending"
                                                        HeadingText="نام" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnDataAccessLevelSourceName_GridDataAccessLevelsSource_MultiPageDataAccessLevels" />
                                                </Columns>
                                            </ComponentArt:GridLevel>
                                        </Levels>
                                        <ClientEvents>
    ...
    <asp:HiddenField runat="server" ID="hffooter_GridDataAccessLevelsSource_MultiPageDataAccessLevels" meta:resourcekey="hffooter_GridDataAccessLevelsSource_MultiPageDataAccessLevels"/>
    <asp:HiddenField runat="server" ID="hffooter_GridDataAccessLevelsTarget_MultiPageDataAccessLevels" meta:resourcekey="hffooter_GridDataAccessLevelsTarget_MultiPageDataAccessLevels"/>
