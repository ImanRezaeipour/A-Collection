<%@ page language="C#" autoeventwireup="true" inherits="LeaveReserve, App_Web_zm3lnrmt" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/LeaveReserve_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogLeaveReserve_Operations.js"></script>
                    ...
                    <tr align="center">
                        ...
                        <td id="Container_DateCalendars_LeaveReserve" runat="server" meta:resourcekey="AlignObj">
                            <table runat="server" id="Container_pdpDate_LeaveReserve" visible="false" style="width: 100%">
                                <tr>
                                    <td>
                                        <pcal:PersianDatePickup ID="pdpDate_LeaveReserve" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="Action" Visible="false" />
                                                </Columns>
