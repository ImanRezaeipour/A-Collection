<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.Calendar, App_Web_zm3lnrmt" %>
...
<body onkeydown="CalendarForm_onKeyDown(event);" style="background-color: #E6E6FA"
    ...
    <script type="text/javascript" src="JS/API/DialogCalendar_Operations.js"></script>
    <script type="text/javascript" src="JS/API/CalendarForm_onKeyDown.js"></script>
    <script type="text/javascript" src="JS/API/CalendarForm_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogPeriodRepeat_onPageLoad.js"></script>
                    ...
                    <tr>
                        ...
                        <td width="40%">
                            <ComponentArt:ComboBox ID="cmbTypes_DialogCalendar" runat="server" AutoComplete="true"
                                ...
                                TextBoxEnabled="false" DropImageUrl="Images/ComboBox/ddn.png" FocusedCssClass="comboBoxHover"
