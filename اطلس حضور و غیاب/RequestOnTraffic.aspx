<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.RequestOnTraffic, App_Web_aaak0nyc" %>
...
<body onkeydown="RequestOnTrafficForm_onKeyDown(event);">
    ...
    <script type="text/javascript" src="JS/API/RequestOnTraffic_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogRequestOnTraffic_Operations.js"></script>
    ...
    <form id="RequestOnTrafficForm" runat="server" meta:resourcekey="RequestOnTrafficForm" onsubmit="return false;">
            ...
            <td>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td id="tdSelectedDate_RequestOnTraffic" class="HeaderLabel" style="width: 30%">
                        </td>
                ...
                <table style="width: 100%;" class="BoxStyle">
                    <tr>
                        <td>
                            <table style="width: 100%">
                                <tr>
                                    <td id="header_TrafficDetails_RequestOnTraffic" class="HeaderLabel" style="width: 50%">
                                        Traffic Details
                                    </td>
                                    <td id="loadingPanel_GridTrafficPairs_RequestOnTraffic" class="HeaderLabel" style="width: 45%">
                                    </td>
        ...
        <tr>
            <td>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea id="txtDescription_RequestOnTraffic" cols="20" name="S1" rows="2" style="height: 100%;
                                width: 99%" class="TextBoxes"></textarea>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table style="width: 100%;" class="BoxStyle">
                    <tr>
                        <td>
                            <table style="width: 100%">
                                <tr>
                                    <td id="header_RegisteredRequests_RequestOnTraffic" class="HeaderLabel" style="width: 50%">
                                        Registered Requests
                                    </td>
                                            ...
                                            <ComponentArt:GridLevel AllowSorting="false" AlternatingRowCssClass="AlternatingRow"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn Align="Center" DataField="Title" DefaultSortDirection="Descending"
                                                        HeadingText="نوع تردد" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnTrafficType_GridRegisteredRequests_RequestOnTraffic" />
                                        ...
                                        <ClientTemplates>
                                            <ComponentArt:ClientTemplate ID="DataCellClientTemplate_clmnState_GridRegisteredRequests_RequestOnTraffic">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td align="center">
                                                            ##GetRequestStateTitle_RequestOnTraffic(DataItem.GetMember('Status').Value)##
                                                        </td>
                                                    </tr>
                                                </table>
