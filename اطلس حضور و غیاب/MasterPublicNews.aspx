<%@ page language="C#" autoeventwireup="true" inherits="MasterPublicNews, App_Web_zm3lnrmt" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="JS/API/MasterPublicNews_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbMasterPublicNews_Operations.js"></script>
                                                        ...
                                                        <ComponentArt:GridLevel AlternatingRowCssClass="AlternatingRow" DataCellCssClass="DataCell"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <ComponentArt:GridColumn Align="Center" DataField="Subject" DefaultSortDirection="Descending"
                                                                    HeadingText="عنوان" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnMasterPublicNewsSubject_GridMasterPublicNews"
                                                                    Width="60" />
                                                                <ComponentArt:GridColumn DataField="Message" DefaultSortDirection="Descending" HeadingText="متن پیام"
                                                                    HeadingTextCssClass="HeadingText" meta:resourcekey="clmnMasterPublicNewsMessage_GridMasterPublicNews"
                                                                    Width="200" />
                                                            </Columns>
