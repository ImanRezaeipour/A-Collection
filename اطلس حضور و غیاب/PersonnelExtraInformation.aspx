<%@ page language="C#" autoeventwireup="true" inherits="PersonnelExtraInformation, App_Web_gtuecu1w" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/PersonnelExtraInformation_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogPersonnelExtraInformation_Operations.js"></script>
    <script type="text/javascript" src="JS/API/DialogPersonnelExtraInformationSettings_onPageLoad.js"></script>
                            ...
                            <ComponentArt:CallBack runat="server" ID="CallBack_cmbValue_R16_DialogPersonnelExtraInformation"
                                ...
                                <Content>
                                    <ComponentArt:ComboBox ID="cmbValue_R16_DialogPersonnelExtraInformation" runat="server"
                                        ...
                                        TextBoxCssClass="comboTextBox" Width="88%" ExpandDirection="Up">
                                        <ClientEvents>
