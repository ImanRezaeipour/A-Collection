<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.RequestOnUnallowableOverTime, App_Web_vccxcelb" %>
...
<body onkeydown="RequestOnUnallowableOverTimeForm_onKeyDown(event);">
    ...
    <script type="text/javascript" src="JS/API/RequestOnUnallowableOverTime_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogRequestOnUnallowableOverTime_Operations.js"></script>
    ...
    <form id="RequestOnUnallowableOverTimeForm" runat="server" meta:resourcekey="RequestOnUnallowableOverTimeForm" onsubmit="return false;">
            ...
            <td>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td id="tdSelectedDate_RequestOnUnallowableOverTime" class="HeaderLabel" style="width: 30%">
                        </td>
                        <td runat="server" id="ActionMode_RequestOnUnallowableOverTime" class="ToolbarMode"
                            style="width: 10%" meta:resourcekey="InverseAlignObj">
                        </td>
                    </tr>
                </table>
            </td>
                                            ...
                                            <Content>
                                                <ComponentArt:ComboBox ID="cmbOverTimeType_RequestOnUnallowableOverTime" runat="server"
                                                    ...
                                                    <ClientEvents>
                                                        ...
                                                        <Collapse EventHandler="cmbOverTimeType_RequestOnUnallowableOverTime_onCollapse" />
                                                    </ClientEvents>
                                            ...
                                            <ComponentArt:GridLevel AllowSorting="false" AlternatingRowCssClass="AlternatingRow"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn Align="Center" DataField="Title" DefaultSortDirection="Descending"
                                                        HeadingText="نوع درخواست" HeadingTextCssClass="HeadingText" meta:resourcekey="clmnRequestType_GridRegisteredRequests_RequestOnUnallowableOverTime" />
                                        ...
                                        <ClientTemplates>
                                            <ComponentArt:ClientTemplate ID="DataCellClientTemplate_clmnState_GridRegisteredRequests_RequestOnUnallowableOverTime">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td align="center">
                                                            ##GetRequestStateTitle_RequestOnUnallowableOverTime(DataItem.GetMember('Status').Value)##
                                                        </td>
                                                    </tr>
                                                </table>
