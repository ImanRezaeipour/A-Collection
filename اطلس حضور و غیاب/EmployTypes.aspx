<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.EmployTypes, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/EmployTypes_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbEmployTypesIntroduction_TabStripMenus_Operations.js"></script>
