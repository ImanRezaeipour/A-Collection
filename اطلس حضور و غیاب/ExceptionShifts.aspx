<%@ page language="C#" autoeventwireup="true" inherits="GTS.Clock.Presentaion.WebForms.ExceptionShifts, App_Web_aaak0nyc" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/ExceptionShifts_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/DialogExceptionShifts_Operations.js"></script>
    <script type="text/javascript" src="JS/API/DialogShiftsView_onPageLoad.js"></script>
    ...
    <table id="Mastertbl_ExceptionShifts" style="font-size: small; background-color: White;
        font-family: Arial;" class="BoxStyle">
        <tr>
            <td valign="top">
                ...
                <ComponentArt:MultiPage ID="MultiPageExceptionShifts" runat="server" CssClass="MultiPage"
                                ...
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <table style="width: 100%;">
                                                    <tr id="Tr9" runat="server" meta:resourcekey="CustomAlignObj">
                                                    ...
                                                    <tr id="Tr10" runat="server" meta:resourcekey="CustomAlignObj">
                                                        <td id="Container_DetailsFromDateCalendars_ExceptionShifts" runat="server" meta:resourcekey="VAlignObj">
                                                            <table runat="server" id="Container_pdpDetailsFromDate_ExceptionShifts" visible="false"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <pcal:PersianDatePickup ID="pdpDetailsFromDate_ExceptionShifts" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td id="Container_DetailsToDateCalendars_ExceptionShifts" runat="server" meta:resourcekey="VAlignObj">
                                                            <table runat="server" id="Container_pdpDetailsToDate_ExceptionShifts" visible="false"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <pcal:PersianDatePickup ID="pdpDetailsToDate_ExceptionShifts" runat="server" CssClass="PersianDatePicker" ReadOnly="true"></pcal:PersianDatePickup>
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td style="height: 30%">
                                    <table style="width: 100%;">
                                                                            ...
                                                                            <Content>
                                                                                <ComponentArt:ComboBox ID="cmbWorkGroup_TwoDayReplacement_ExceptionShifts" runat="server"
                                                                                    ...
                                                                                    <ClientEvents>
                                                                                        ...
                                                                                        <Collapse EventHandler="cmbWorkGroup_TwoDayReplacement_ExceptionShifts_onCollapse" />
                                                                                    </ClientEvents>
                                                                                </ComponentArt:ComboBox>
                                                ...
                                                <table style="width: 100%;" class="BoxStyle">
                                                    <tr>
                                                        <td id="Container_rdbPersonnel_TwoDayReplacement_ExceptionShifts" style="width: 20%"
                                                            valign="top">
                                                            <table runat="server" meta:resourcekey="tbl_rdbPersonnel_TwoDayReplacement_ExceptionShifts">
                                                                <tr>
                                                                    <td style="width: 5%">
                                                                                                ...
                                                                                                <Content>
                                                                                                    <ComponentArt:ComboBox ID="cmbPersonnel_TwoDayReplacement_ExceptionShifts" runat="server"
                                                                                                        ...
                                                                                                        <ClientEvents>
                                                                                                            ...
                                                                                                            <Collapse EventHandler="cmbPersonnel_TwoDayReplacement_ExceptionShifts_onCollapse" />
                                        ...
                                        <tr id="Tr1" runat="server" meta:resourcekey="CustomAlignObj">
                                        ...
                                        <tr id="Tr2" runat="server" meta:resourcekey="CustomAlignObj">
                                            <td id="Td6" runat="server">
                                                <table style="width: 100%;" class="BoxStyle">
                                                    <tr>
                                                        <td>
                                                            <table style="width: 100%;">
                                                                <tr id="Tr3" runat="server" meta:resourcekey="CustomAlignObj">
                                                                ...
                                                                <tr id="Tr4" runat="server" meta:resourcekey="CustomAlignObj">
                                                                    <td>
                                                                ...
                                                                <tr id="Tr5" runat="server" meta:resourcekey="CustomAlignObj">
                                                                    <td>
                                                        ...
                                                        <td align="center" style="color: White; width: 5%">
                                                            &lt;&lt;&gt;&gt;
                                                        </td>
                                                        <td>
                                                            <table style="width: 100%;">
                                                                <tr id="Tr6" runat="server" meta:resourcekey="CustomAlignObj">
                                                                ...
                                                                <tr id="Tr7" runat="server" meta:resourcekey="CustomAlignObj">
                                                                    <td>
                                                                ...
                                                                <tr id="Tr8" runat="server" meta:resourcekey="CustomAlignObj">
                                                                    <td>
                    ...
                    <ComponentArt:PageView CssClass="PageContent" runat="server" ID="pgvTwoPersonnelReplacement_TabStripShiftDetails"
                        ...
                        <table class="BoxStyle" style="width: 100%; font-family: Arial; font-size: small">
                                                                            ...
                                                                            <Content>
                                                                                <ComponentArt:ComboBox ID="cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts"
                                                                                    ...
                                                                                    <ClientEvents>
                                                                                        ...
                                                                                        <Collapse EventHandler="cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCollapse" />
                                                                                    </ClientEvents>
                                                                                </ComponentArt:ComboBox>
                                                                            ...
                                                                            <Content>
                                                                                <ComponentArt:ComboBox ID="cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts"
                                                                                    ...
                                                                                    <ClientEvents>
                                                                                        ...
                                                                                        <Collapse EventHandler="cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCollapse" />
                                                                                    </ClientEvents>
                                                                                </ComponentArt:ComboBox>
                                                        ...
                                                        <td style="width: 50%">
                                                            <table style="width: 100%">
                                                                <tr>
                                                                    ...
                                                                    <td align="center" style="color: White" id="tdSelectedPersonnel_SearchByPersonnel1_TwoPersonnelReplacement_ExceptionShifts">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                                                ...
                                                                                                <Content>
                                                                                                    <ComponentArt:ComboBox ID="cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts"
                                                                                                        ...
                                                                                                        <ClientEvents>
                                                                                                            ...
                                                                                                            <Collapse EventHandler="cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts_onCollapse" />
                                                                                                ...
                                                                                                <Content>
                                                                                                    <ComponentArt:ComboBox ID="cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts"
                                                                                                        ...
                                                                                                        <ClientEvents>
                                                                                                            ...
                                                                                                            <Collapse EventHandler="cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts_onCollapse" />
                            ...
                            <tr>
                                <td runat="server" meta:resourcekey="CustomAlignObj">
                                ...
                                <td>
                                    <table class="BoxStyle" style="width: 100%;">
                                        <tr>
                                            <td>
                                                <table style="width: 100%;">
                                                    <tr id="Tr15" runat="server" meta:resourcekey="CustomAlignObj">
                                            ...
                                            <td>
                                                <table style="width: 100%;">
                                                    <tr id="Tr13" runat="server" meta:resourcekey="CustomAlignObj">
