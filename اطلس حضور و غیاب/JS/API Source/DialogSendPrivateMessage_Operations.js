...
function UpdateUnderManagement_SendPrivateMessagePage_onCallBack(Response) {
    ...
    if (RetMessage != null && RetMessage.length > 0) {
        ...
        if (RetMessage[2] == 'success' && RetMessage[3] != "" && RetMessage[3] != '0') {
            ...
            ObjUnderManagement_SendPrivateMessage.FlowID = RetMessage[3];
            if (CurrentPageState_SendPrivateMessage == 'Add')
                ChangePageState_SendPrivateMessage('AfterAdd');
            parent.document.getElementById('pgvWorkFlowsView_iFrame').contentWindow.UnderManagement_onAfterUpdate(CurrentPageState_SendPrivateMessage, ObjUnderManagement_SendPrivateMessage);
        }
    }
}
function ChangePageState_SendPrivateMessage(state) {
    switch (state) {
        case 'Add':
            ...
            break;
        case 'AfterAdd':
            TlbSendPrivateMessage.get_items().getItemById('tlbItemSave_TlbSendPrivateMessage').set_enabled(false);
            TlbSendPrivateMessage.get_items().getItemById('tlbItemSave_TlbSendPrivateMessage').set_imageUrl('save_silver.png');
            if (TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessCreation_TlbSendPrivateMessage') != null) {
                TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessCreation_TlbSendPrivateMessage').set_enabled(true);
                TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessCreation_TlbSendPrivateMessage').set_imageUrl('access.png');
            }
            if (TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessView_TlbSendPrivateMessage') != null) {
                TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessView_TlbSendPrivateMessage').set_enabled(true);
                TlbSendPrivateMessage.get_items().getItemById('tlbItemExeptionAccessView_TlbSendPrivateMessage').set_imageUrl('exceptions.png');
            }
            if (TlbSendPrivateMessage.get_items().getItemById('tlbItemWorkFlow_TlbSendPrivateMessage') != null) {
                TlbSendPrivateMessage.get_items().getItemById('tlbItemWorkFlow_TlbSendPrivateMessage').set_enabled(true);
                TlbSendPrivateMessage.get_items().getItemById('tlbItemWorkFlow_TlbSendPrivateMessage').set_imageUrl('flowCreate.png');
            }
            break;
        case 'Edit':
            document.getElementById('Container_headerBox_SendPrivateMessage').removeChild(document.getElementById('headerBox_SendPrivateMessage'));
            var ObjPageState_SendPrivateMessage = parent.DialogSendPrivateMessage.get_value();
            document.getElementById('cmbAccessGroup_SendPrivateMessage_Input').value = ObjPageState_SendPrivateMessage.AccessGroupName;
            document.getElementById('txtFlowName_SendPrivateMessage').value = ObjPageState_SendPrivateMessage.FlowName;
            break;
    }
}
...
function CloseDilaogSendPrivateMessage() {
    parent.document.getElementById('DialogSendPrivateMessage_IFrame').src = 'WhitePage.aspx';
    parent.DialogSendPrivateMessage.Close();
}
