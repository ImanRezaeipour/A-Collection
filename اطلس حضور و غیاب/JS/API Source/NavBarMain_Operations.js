...
var BaseContentUrl_DialogCartable_NavBarMain = null;
function CheckException_nvbItem_NavBarMain(NavBarItemID) {
    var ExceptionOccured = false;
    var ObjDialogCartable = new Object();
    switch (NavBarItemID) {
        case 'nvbItemCartable_NavBarMain':
            ExceptionOccured = true;
            ObjDialogCartable.RequestCaller = 'Cartable';
            DialogCartable.set_value(ObjDialogCartable);
            DialogCartable.Show();
            break;
        case 'nvbItemSurveyedRequests_NavBarMain':
            ExceptionOccured = true;
            ObjDialogCartable.RequestCaller = 'Survey';
            DialogCartable.set_value(ObjDialogCartable);
            DialogCartable.Show();
            break;
        case 'nvbItemSentry_NavBarMain':
            ExceptionOccured = true;
            ObjDialogCartable.RequestCaller = 'Sentry';
            DialogCartable.set_value(ObjDialogCartable);
            DialogCartable.Show();
            break;
