...
function ChangePageState_ManagersWorkFlow(state) {
    ...
    document.getElementById('chbActiveFlow_ManagersWorkFlow').checked = false;
}
...
function UpdateManagersWorkFlow_ManagersWorkFlow() {
    ...
    UpdateManagersWorkFlow_ManagersWorkFlowPage(CharToKeyCode_ManagersWorkFlow(ObjManagerWorkFlow_ManagerWorkFlow.FlowID), CharToKeyCode_ManagersWorkFlow(ObjManagerWorkFlow_ManagerWorkFlow.IsActiveFlow.toString()), CharToKeyCode_ManagersWorkFlow(ObjManagerWorkFlow_ManagerWorkFlow.FlowPartsList));
}
...
function ManagersWorkFlow_onAfterUpdate() {
    if (ObjManagerWorkFlow_ManagerWorkFlow != null) {
        parent.parent.document.getElementById('pgvWorkFlowsView_iFrame').contentWindow.ManagerWorkFlow_onAfterUpdate(ObjManagerWorkFlow_ManagerWorkFlow.FlowID, ObjManagerWorkFlow_ManagerWorkFlow.IsActiveFlow);
        parent.parent.document.getElementById('DialogUnderManagementPersonnel_IFrame').contentWindow.ManagerWorkFlow_onAfterUpdate(ObjManagerWorkFlow_ManagerWorkFlow.IsActiveFlow);
    }
}
...
function CloseDialogManagersWorkFlow() {
    parent.document.getElementById('DialogManagersWorkFlow_IFrame').src = 'WhitePage.aspx';
    parent.DialogManagersWorkFlow.Close();
}
...
function cmbPersonnel_ManagersWorkFlow_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbPersonnel_ManagersWorkFlow) {
        CurrentPageCombosCallBcakStateObj.cmbPersonnel_ManagersWorkFlow = false;
...
function CallBack_cmbPersonnel_ManagersWorkFlow_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        ...
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbPersonnel_ManagersWorkFlow = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbPersonnel_ManagersWorkFlow = false;
        cmbPersonnel_ManagersWorkFlow.expand();
    }
...
function tlbItemFormReconstruction_TlbManagersWorkFlow_onClick() {
    CloseDialogManagersWorkFlow();
    parent.parent.document.getElementById('DialogUnderManagementPersonnel_IFrame').contentWindow.ShowDialogManagersWorkFlow();
}
