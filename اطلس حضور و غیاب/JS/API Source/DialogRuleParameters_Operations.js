...
function UpdateRuleParameter_RuleParameters() {
    ...
    UpdateRuleParameter_RuleParametersPage(CharToKeyCode_RuleParameters(CurrentPageState_RuleParameters), CharToKeyCode_RuleParameters(ObjDialogRuleParameters.RuleGroupID), CharToKeyCode_RuleParameters(ObjDialogRuleParameters.RuleID), CharToKeyCode_RuleParameters(ObjRuleParameter_RuleParameters.ID), CharToKeyCode_RuleParameters(ObjRuleParameter_RuleParameters.FromDate), CharToKeyCode_RuleParameters(ObjRuleParameter_RuleParameters.ToDate), CharToKeyCode_RuleParameters('[' + ObjDateRangeParametersValue_RuleParameters + ']'));
}
...
function CloseDialogRuleParameters() {
    parent.document.getElementById('DialogRuleParameters_IFrame').src = "WhitePage.aspx";
    parent.DialogRuleParameters.Close();
}
...
function Fill_GridRuleDateRanges_RuleParameters() {
    ...
    CallBack_GridRuleDateRanges_RuleParameters.callback(ObjDialogRuleParameters.RuleGroupID, ObjDialogRuleParameters.RuleID);
}
...
function UpdateDateRangeRuleParametersList_RuleParameters(ruleParameterValue) {
    ...
    var NewParameterValueMember_RuleParameters = '{"ID":"' + selectedRuleParameterID + '","Name":"' + selectedRuleParameterName + '","Type":"' + selectedRuleParameterType + '","Value":"' + ruleParameterValue + '"}';
    var OldParameterValueMember_RuleParameters = '{"ID":"' + selectedRuleParameterID + '","Name":"' + selectedRuleParameterName + '","Type":"' + selectedRuleParameterType + '","Value":"' + selectedRuleParameterValue + '"}';
    ...
    var splitter = '';
    if (ObjDateRangeParametersValue_RuleParameters != '')
        splitter = ',';
...
function tlbItemFormReconstruction_TlbRuleParameters_onClick() {
    CloseDialogRuleParameters();
    parent.parent.document.getElementById('DialogRulesGroupUpdate_IFrame').contentWindow.ShowDialogRuleParameters();
}
