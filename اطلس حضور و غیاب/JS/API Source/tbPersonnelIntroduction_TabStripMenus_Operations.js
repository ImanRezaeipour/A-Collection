    ...
    switch (CurrentPageState_Personnel) {
        ...
        case 'Edit':
            ...
            if (selectedPersonnel_Personnel != undefined) {
                ...
                CurrentStateObj_Personnel.Reserve16Text = selectedPersonnel_Personnel.getMember('PersonDetail.R16Text').get_text();
                CurrentStateObj_Personnel.Reserve17 = selectedPersonnel_Personnel.getMember('PersonDetail.R17').get_text();
                CurrentStateObj_Personnel.Reserve17Text = selectedPersonnel_Personnel.getMember('PersonDetail.R17Text').get_text();
                CurrentStateObj_Personnel.Reserve18 = selectedPersonnel_Personnel.getMember('PersonDetail.R18').get_text();
                CurrentStateObj_Personnel.Reserve18Text = selectedPersonnel_Personnel.getMember('PersonDetail.R18Text').get_text();
                CurrentStateObj_Personnel.Reserve19 = selectedPersonnel_Personnel.getMember('PersonDetail.R19').get_text();
                CurrentStateObj_Personnel.Reserve19Text = selectedPersonnel_Personnel.getMember('PersonDetail.R19Text').get_text();
                CurrentStateObj_Personnel.Reserve20 = selectedPersonnel_Personnel.getMember('PersonDetail.R20').get_text();
                CurrentStateObj_Personnel.Reserve20Text = selectedPersonnel_Personnel.getMember('PersonDetail.R20Text').get_text();
                CurrentStateObj_Personnel.StrPersonnelExtraInformation = '';
...
function MasterPersonnelMainInformation_onAfterPersonnelAdvancedSearch(SearchTerm) {
    SearchTerm = AdvancedSearchTerm_Personnel ;
    SetPageIndex_GridPersonnel_Personnel(0);
}
