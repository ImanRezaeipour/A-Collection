...
function tlbItemEndorsement_TlbExceptionShiftsDetails_onClick() {
    ...
    UpdateExceptionShift_ExceptionShifts();
}
...
function CloseDialogExceptionShifts() {
    parent.document.getElementById('DialogExceptionShifts_IFrame').src = 'WhitePage.aspx';
    parent.DialogExceptionShifts.Close();
...
function cmbShift_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbShift_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbShift_ExceptionShifts = false;
...
function CallBack_cmbShift_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbShift_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbShift_ExceptionShifts = false;
...
function cmbWorkGroup_TwoDayReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbWorkGroup_TwoDayReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbWorkGroup_TwoDayReplacement_ExceptionShifts = false;
...
function CallBack_cmbWorkGroup_TwoDayReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbWorkGroup_TwoDayReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbWorkGroup_TwoDayReplacement_ExceptionShifts = false;
...
function cmbPersonnel_TwoDayReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbPersonnel_TwoDayReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbPersonnel_TwoDayReplacement_ExceptionShifts = false;
...
function CallBack_cmbPersonnel_TwoDayReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbPersonnel_TwoDayReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbPersonnel_TwoDayReplacement_ExceptionShifts = false;
...
function cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = false;
...
function CallBack_cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbFirstPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = false;
...
function cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = false;
...
function CallBack_cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbSecondPersonnelWorkGroup_TwoPersonnelReplacement_ExceptionShifts = false;
...
function cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts = false;
...
function CallBack_cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts = false;
        document.getElementById('cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts_DropDown').style.display = 'none';
        cmbPersonnel1_TwoPersonnelReplacement_ExceptionShifts.expand();
        var personnelCount = document.getElementById('hfPersonnelCount_Personnel1_TwoPersonnelReplacement_ExceptionShifts').value;
    }
    else {
        var errorParts = eval('(' + error + ')');
        showDialog(errorParts[0], errorParts[1], errorParts[2]);
...
function cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts) {
        CurrentPageCombosCallBcakStateObj.cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts = false;
...
function CallBack_cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbPersonnel2_TwoPersonnelReplacement_ExceptionShifts = false;
...
function UpdateExceptionShift_ExceptionShifts() {
    var ObjDialogExceptionShifts = parent.DialogExceptionShifts.get_value();
