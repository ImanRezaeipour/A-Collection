...
function cmbReserveFields_PersonnelExtraInformationSettings_onCollapse(sender, e) {
    if (CurrentPageCombosCallBcakStateObj.cmbReserveFields_PersonnelExtraInformationSettings) {
        CurrentPageCombosCallBcakStateObj.cmbReserveFields_PersonnelExtraInformationSettings = false;
...
function CallBack_cmbReserveFields_PersonnelExtraInformationSettings_onCallbackComplete(sender, e) {
    ...
    if (error == "") {
        ...
        if (CheckNavigator_onCmbCallBackCompleted())
            CurrentPageCombosCallBcakStateObj.cmbReserveFields_PersonnelExtraInformationSettings = true;
        else
            CurrentPageCombosCallBcakStateObj.cmbReserveFields_PersonnelExtraInformationSettings = false;
        cmbReserveFields_PersonnelExtraInformationSettings.expand();
    }
