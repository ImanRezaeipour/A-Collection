<%@ page language="C#" autoeventwireup="true" inherits="Illnesses, App_Web_vccxcelb" %>
...
<body>
    ...
    <script type="text/javascript" src="JS/API/Illnesses_onPageLoad.js"></script>
    <script type="text/javascript" src="JS/API/tbIllnesses_TabStripMenus_Operations.js"></script>
                                        ...
                                        <ComponentArt:CallBack ID="CallBack_GridIllness_Illness" runat="server" OnCallback="CallBack_GridIllness_Illness_onCallBack">
                                            <Content>
                                                <ComponentArt:DataGrid ID="GridIllness_Illness" runat="server" AllowColumnResizing="false"
                                                    AllowMultipleSelect="false" CssClass="Grid" EnableViewState="true" FillContainer="true"
                                ...
                                <tr runat="server" meta:resourcekey="AlignObj">
                                    <td>
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" runat="server" style="width: 98%;" class="TextBoxes" id="txtDescription_Illness"
                                                        disabled="disabled" />
                                                </td>
                                            </tr>
                                        </table>
