...
-------------------------------------------------------------------------------------------------------------
set @ReportFile_Name=N'R4343A770'
set @Report_Name=N'خلاصه گزارش کارکرد ماهیانه - فلات'
...
<StiSerializer version="1.02" type="Net" application="StiReport">
  <Dictionary Ref="1" type="Dictionary" isKey="true">
    ...
    <DataSources isList="true" count="2">
      <MonthlyReport_MonthlyValue Ref="3" type="Stimulsoft.Report.Dictionary.StiSqlSource" isKey="true">
        ...
        <Columns isList="true" count="39">
          ...
          <value>rest,System.String</value>
          <value>tatil,System.String</value>
        </Columns>
	...
	,(SELECT TOP(1) scv.ScndCnpValue_Value FROM dbo.TA_SecondaryConceptValue scv
	WHERE scv.ScndCnpValue_SecondaryConceptId=(SELECT ConceptTmp_ID FROM dbo.TA_ConceptTemplate WHERE ConceptTmp_IdentifierCode=1502)
	AND scv.ScndCnpValue_PersonId=ScndCnpValue.ScndCnpValue_PersonId
	AND @ToDate BETWEEN scv.ScndCnpValue_FromDate AND scv.ScndCnpValue_ToDate) AS rest
	,(SELECT TOP(1) scv.ScndCnpValue_Value FROM dbo.TA_SecondaryConceptValue scv
	WHERE scv.ScndCnpValue_SecondaryConceptId=(SELECT ConceptTmp_ID FROM dbo.TA_ConceptTemplate WHERE ConceptTmp_IdentifierCode=4022)
	AND scv.ScndCnpValue_PersonId=ScndCnpValue.ScndCnpValue_PersonId
	AND @ToDate BETWEEN scv.ScndCnpValue_FromDate AND scv.ScndCnpValue_ToDate) AS tatil
	FROM (							        
SELECT ISNULL(SUM([gridFields_NecessaryOperation]), -1000) [gridFields_NecessaryOperation]
      ,ISNULL(SUM([gridFields_HourlyPureOperation]), -1000) [gridFields_HourlyPureOperation]
      ,ISNULL(SUM([gridFields_DailyPureOperation]), -1000) [gridFields_DailyPureOperation]
      ,ISNULL(SUM([gridFields_ImpureOperation]), -1000) [gridFields_ImpureOperation]
      ,ISNULL(SUM([gridFields_AllowableOverTime]), -1000) [gridFields_AllowableOverTime]
      ,ISNULL(SUM([gridFields_UnallowableOverTime]), -1000) [gridFields_UnallowableOverTime]
      ,ISNULL(SUM([gridFields_HourlyAllowableAbsence]), -1000) [gridFields_HourlyAllowableAbsence]
      ,ISNULL(SUM([gridFields_HourlyUnallowableAbsence]), -1000) [gridFields_HourlyUnallowableAbsence]
      ,ISNULL(SUM([gridFields_DailyAbsence]), -1000) [gridFields_DailyAbsence]
      ,ISNULL(SUM([gridFields_HourlyMission]), -1000) [gridFields_HourlyMission]
      ,ISNULL(SUM([gridFields_DailyMission]), -1000) [gridFields_DailyMission]
      ,ISNULL(SUM([gridFields_HostelryMission]), -1000) [gridFields_HostelryMission]
      ,ISNULL(SUM([gridFields_HourlySickLeave]), -1000) [gridFields_HourlySickLeave]
      ,ISNULL(SUM([gridFields_DailySickLeave]), -1000) [gridFields_DailySickLeave]
      ,ISNULL(SUM([gridFields_HourlyMeritoriouslyLeave]), -1000) [gridFields_HourlyMeritoriouslyLeave]
      ,ISNULL(SUM([gridFields_DailyMeritoriouslyLeave]), -1000) [gridFields_DailyMeritoriouslyLeave]
      ,ISNULL(SUM([gridFields_HourlyWithoutPayLeave]), -1000) [gridFields_HourlyWithoutPayLeave]
      ,ISNULL(SUM([gridFields_PresenceDuration]), -1000) [gridFields_PresenceDuration]
      ,ISNULL(SUM([gridFields_DailyWithoutPayLeave]), -1000) [gridFields_DailyWithoutPayLeave]
      ,ISNULL(SUM([gridFields_HourlyWithPayLeave]), -1000) [gridFields_HourlyWithPayLeave]
      ,ISNULL(SUM([gridFields_DailyWithPayLeave]), -1000) [gridFields_DailyWithPayLeave]
      ,ISNULL(SUM([gridFields_ReserveField1]), -1000) [gridFields_ReserveField1]
      ,ISNULL(SUM([gridFields_ReserveField2]), -1000) [gridFields_ReserveField2]
      ,ISNULL(SUM([gridFields_ReserveField3]), -1000) [gridFields_ReserveField3]
      ,ISNULL(SUM([gridFields_ReserveField4]), -1000) [gridFields_ReserveField4]
      ,ISNULL(SUM([gridFields_ReserveField5]), -1000) [gridFields_ReserveField5]
      ,ISNULL(SUM([gridFields_ReserveField6]), -1000) [gridFields_ReserveField6]
      ,ISNULL(SUM([gridFields_ReserveField7]), -1000) [gridFields_ReserveField7]
      ,ISNULL(SUM([gridFields_ReserveField8]), -1000) [gridFields_ReserveField8]
      ,ISNULL(SUM([gridFields_ReserveField9]), -1000) [gridFields_ReserveField9]
      ,ISNULL(SUM([gridFields_ReserveField10]), -1000) [gridFields_ReserveField10]
      ,ScndCnpValue_PersonId
      ,ScndCnpValue_PeriodicFromDate
      ,ScndCnpValue_PeriodicToDate
...
ON ScndCnpValue.ScndCnpValue_PersonId = Prs.Prs_ID</SqlCommand>
    ...
    <pgeReport Ref="5" type="Page" isKey="true">
      ...
      <Components isList="true" count="4">
        <phbMain Ref="6" type="PageHeaderBand" isKey="true">
          <Brush>Transparent</Brush>
          <ClientRectangle>0,0.4,31.7,2</ClientRectangle>
          <Components isList="true" count="9">
            <txtOrgDefName Ref="7" type="Text" isKey="true">
              ...
              <ClientRectangle>6.2,0,15,1.8</ClientRectangle>
...
خلاصه گزارش کارکرد ماهیانه</Text>
            ...
            <txtFromDate Ref="8" type="Text" isKey="true">
              ...
              <CanGrow>True</CanGrow>
              <CanShrink>True</CanShrink>
              <ClientRectangle>29.8,1.2,1.4,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
            ...
            <txtPeriodicFromDate Ref="9" type="Text" isKey="true">
              ...
              <CanGrow>True</CanGrow>
              <CanShrink>True</CanShrink>
              <ClientRectangle>27.4,1.2,2.4,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Tahoma,8,Bold</Font>
            ...
            <txtToDate Ref="10" type="Text" isKey="true">
              ...
              <CanGrow>True</CanGrow>
              <CanShrink>True</CanShrink>
              <ClientRectangle>25,1.2,1.4,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Tahoma,8,Bold</Font>
            ...
            <txtPeriodicToDate Ref="11" type="Text" isKey="true">
              ...
              <CanGrow>True</CanGrow>
              <CanShrink>True</CanShrink>
              <ClientRectangle>22.8,1.2,2.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Tahoma,8,Bold</Font>
        ...
        <pfbMain Ref="16" type="PageFooterBand" isKey="true">
          <Brush>Transparent</Brush>
          <ClientRectangle>0,19.4,31.7,0.6</ClientRectangle>
        ...
        <hdrMain Ref="17" type="HeaderBand" isKey="true">
          ...
          <Components isList="true" count="24">
            ...
            <htPresenceDuration Ref="19" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>21.5,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyWithoutPayLeave Ref="20" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>4.2,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htDailyMeritoriouslyLeave Ref="21" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>5.2,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyMeritoriouslyLeave Ref="22" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>6.2,0,1.2,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htDailySickLeave Ref="23" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>7.4,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlySickLeave Ref="24" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>8.4,0,1.2,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHostelryMission Ref="25" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>9.6,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htDailyMission Ref="26" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>10.6,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyMission Ref="27" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>11.6,0,1.2,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htDailyAbsence Ref="28" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>12.8,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyUnallowableAbsence Ref="29" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>13.8,0,1.2,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyAllowableAbsence Ref="30" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>15,0,1.2,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htAllowableOverTime Ref="31" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>17.3,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htUnallowableOverTime Ref="32" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>16.2,0,1.1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htHourlyPureOperation Ref="33" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>20.1,0,1.4,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htDailyPureOperation Ref="34" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>19.3,0,0.8,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htNecessaryOperation Ref="35" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>22.5,0,1.1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htPrsBarCode Ref="36" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>27.2,0,3.1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htName Ref="37" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>23.6,0,3.6,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htLine Ref="38" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>30.2,0,1.5,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <htImpureOperation Ref="39" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>18.3,0,1,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
            ...
            <Text1 Ref="40" type="Text" isKey="true">
              ...
              <Brush>[191:191:191]</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>1.6,0,1.4,1</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
              <Guid>eadbd0d013bc48eeaef648cf5b6d1835</Guid>
              <HorAlignment>Center</HorAlignment>
              <Margins>0,0,0,0</Margins>
              <Name>Text1</Name>
              <Page isRef="5" />
            ...
            <Text2 Ref="41" type="Text" isKey="true">
              ...
              <Conditions isList="true" count="0" />
              <Font>Arial,7.75</Font>
              <Guid>ae04b7a620b847858f0d72ed2ff40012</Guid>
              <HorAlignment>Center</HorAlignment>
              <Margins>0,0,0,0</Margins>
              <Name>Text2</Name>
              <Page isRef="5" />
              <Parent isRef="17" />
              <Text>تعطیل کاری</Text>
              <TextBrush>Black</TextBrush>
              <TextOptions>HotkeyPrefix=None, LineLimit=False, RightToLeft=False, Trimming=None, WordWrap=True, Angle=0, FirstTabOffset=40, DistanceBetweenTabs=20,</TextOptions>
              <VertAlignment>Center</VertAlignment>
            </Text2>
        ...
        <dbMain Ref="42" type="DataBand" isKey="true">
          <Border>All;Black;1;Solid;False;4;Black</Border>
          <Brush>Transparent</Brush>
          <BusinessObjectGuid isNull="true" />
          <ClientRectangle>0,5,31.7,0.5</ClientRectangle>
          <ColumnDirection>DownThenAcross</ColumnDirection>
          <Components isList="true" count="24">
            <dtDailyWithoutPayLeave Ref="43" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>3,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
              <Guid>59a0bdaccebd45c59b726df9dff52e3e</Guid>
              <HorAlignment>Center</HorAlignment>
              <Margins>0,0,0,0</Margins>
            ...
            <dtHourlyWithoutPayLeave Ref="44" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
            ...
            <dtDailyMeritoriouslyLeave Ref="45" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>5.2,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHourlyMeritoriouslyLeave Ref="46" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>6.2,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtDailySickLeave Ref="47" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>7.4,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHourlySickLeave Ref="48" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>8.4,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHostelryMission Ref="49" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>9.6,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtDailyMission Ref="50" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
            ...
            <dtHourlyMission Ref="51" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>11.6,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtDailyAbsence Ref="52" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>12.8,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHourlyUnallowableAbsence Ref="53" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>13.8,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHourlyAllowableAbsence Ref="54" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>15,0,1.2,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtAllowableOverTime Ref="55" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>17.3,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtUnallowableOverTime Ref="56" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>16.2,0,1.1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtNecessaryOperation Ref="57" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>22.5,0,1.1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtPresenceDuration Ref="58" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>21.5,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtHourlyPureOperation Ref="59" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>20.1,0,1.4,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtDailyPureOperation Ref="60" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>19.3,0,0.8,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtName Ref="61" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>23.6,0,3.6,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Tahoma,8</Font>
            ...
            <dtPrsBarCode Ref="62" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>27.2,0,3.1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <dtLine Ref="63" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>30.2,0,1.5,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
            ...
            <dtImpureOperation Ref="64" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>18.3,0,1,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
            ...
            <Text3 Ref="65" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>1.6,0,1.4,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
              <Guid>7b99a492e494466a83b5f7ffd2dbf584</Guid>
              <HorAlignment>Center</HorAlignment>
              <Margins>0,0,0,0</Margins>
              <Name>Text3</Name>
              <Page isRef="5" />
              <Parent isRef="42" />
              <Text>{MonthlyReport_MonthlyValue.rest}</Text>
              <TextBrush>Black</TextBrush>
              <TextOptions>HotkeyPrefix=None, LineLimit=False, RightToLeft=False, Trimming=None, WordWrap=True, Angle=0, FirstTabOffset=40, DistanceBetweenTabs=20,</TextOptions>
              <Type>DataColumn</Type>
              <VertAlignment>Center</VertAlignment>
            </Text3>
            <Text4 Ref="66" type="Text" isKey="true">
              <Border>All;Black;1;Solid;False;4;Black</Border>
              <Brush>Transparent</Brush>
              <CanGrow>True</CanGrow>
              <ClientRectangle>0,0,1.6,0.5</ClientRectangle>
              <Conditions isList="true" count="0" />
              <Font>Arial,8</Font>
              <Guid>01b8825926a747b99657692c5e6aaed5</Guid>
              <HorAlignment>Center</HorAlignment>
              <Margins>0,0,0,0</Margins>
              <Name>Text4</Name>
              <Page isRef="5" />
              <Parent isRef="42" />
              <Text>{MonthlyReport_MonthlyValue.tatil}</Text>
              <TextBrush>Black</TextBrush>
              <TextOptions>HotkeyPrefix=None, LineLimit=False, RightToLeft=False, Trimming=None, WordWrap=True, Angle=0, FirstTabOffset=40, DistanceBetweenTabs=20,</TextOptions>
              <Type>DataColumn</Type>
              <VertAlignment>Center</VertAlignment>
  ...
  <ReportChanged>6/3/2013 11:00:01 AM</ReportChanged>
  <ReportCreated>11/6/2011 9:01:08 AM</ReportCreated>
  <ReportFile>E:\SummaryMonthlyReport\SummaryMonthlyReport.mrt</ReportFile>
  <ReportGuid>e7e157a339f64f1190e42cd72375451a</ReportGuid>
...
namespace Reports
{
  ...
  <Styles isList="true" count="3">
    <Master Ref="69" type="Stimulsoft.Report.StiStyle" isKey="true">
    ...
    <EventStyle Ref="70" type="Stimulsoft.Report.StiStyle" isKey="true">
    ...
    <Style1 Ref="71" type="Stimulsoft.Report.StiStyle" isKey="true">
      <Brush>Transparent</Brush>
      <Conditions isList="true" count="0" />
      <Description />
      <Font>Arial,8</Font>
