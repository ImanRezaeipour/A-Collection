...
namespace ImportExcell
{
    ...
    public partial class TA_Person
    {
        ...
        public bool prs_IsDeleted { get; set; }
        public Nullable<decimal> prs_GradeId { get; set; }
        public System.DateTime prs_CreationDate { get; set; }
        public string Prs_DigitalSignature { get; set; }
    
        public virtual TA_PersonDetail TA_PersonDetail { get; set; }
        public virtual TA_EmploymentType TA_EmploymentType { get; set; }
        public virtual TA_Grade TA_Grade { get; set; }
    }
}
